...
INSERT INTO authors (name, last_name, birth_date)
VALUES
...
INSERT INTO book_base (name, genre_id, isbn, write_date)
VALUES
    ('The Lord of the Rings', 1, '9780618640157', '1954-07-29'),
    ('The Hobbit', 1, '9780547928227', '1937-09-21'),
    ('War and Peace', 2, '9780199232765', '1869-01-01'),
    ('Anna Karenina', 5, '9780143035008', '1877-01-01'),
    ('The Adventures of Huckleberry Finn', 5, '9780199536559', '1884-12-10'),
    ('Oliver Twist', 5, '9780141439747', '1837-01-01'),
    ('To the Lighthouse', 5, '9780156907392', '1927-05-05'),
    ('Mrs. Dalloway', 5, '9780156030359', '1925-05-14'),
    ('To Kill a Mockingbird', 5, '9780446310789', '1960-07-11'),
    ('The Great Gatsby', 5, '9780743273565', '1925-04-10'),
    ('For Whom the Bell Tolls', 5, '9780684803357', '1940-10-21'),
    ('A Farewell to Arms', 5, '9780684801469', '1929-09-27');
...
create table publishers(
    ...
    name varchar(256),
    description varchar(256),
    country varchar(256), --TODO: country tablica
    contacts varchar(256)
);
INSERT INTO publishers (name, description, country, contacts)
VALUES
    ('Penguin Random House', 'Publishing company known for a wide range of books.', 'United States', 'contact@penguinrandomhouse.com'),
    ('HarperCollins Publishers', 'One of the world largest publishing companies.', 'United States', 'info@harpercollins.com'),
    ('Simon & Schuster', 'Global publishing company known for bestsellers and literary fiction.', 'United States', 'info@simonandschuster.com'),
    ('Macmillan Publishers', 'Global trade publishing company.', 'United Kingdom', 'info@macmillan.com'),
    ('Hachette Livre', 'Largest publishing company in France and one of the largest in the world.', 'France', 'info@hachette.fr'),
    ('Pearson plc', 'Multinational publishing and education company.', 'United Kingdom', 'contact@pearson.com'),
    ('Oxford University Press', 'Largest university press in the world.', 'United Kingdom', 'info@oup.com');
